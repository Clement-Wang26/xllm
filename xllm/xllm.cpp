...
int run() {
  ...
  if (FLAGS_speculative_algorithm != "mtp" &&
      FLAGS_speculative_algorithm != "suffix") {
    LOG(FATAL) << "Invalid --speculative_algorithm: "
               << FLAGS_speculative_algorithm
               << ", expected one of: mtp, suffix";
  }
